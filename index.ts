...
export const repos = {
	...
	forks: [
		...
		forks.ryankurtePki.repo.name,
		forks.skopeo.repo.name,
	...
	homelab: [
		...
		homelab.cairn.repo.name,
		homelab.controlPlane.repo.name,
		homelab.inoculant.repo.name,
	...
	utilities: [
		utilities.forkctl.repo.name,
		utilities.gossamer2nix.repo.name,
		utilities.ideas.repo.name,
		...
		utilities.relationships.repo.name,
		utilities.travel.repo.name,
	...
	terraform: [
		terraform.terraformProviderGit.repo.name,
		terraform.terraformProviderPfSense.repo.name,
		terraform.terraformProviderSmallImprovements.repo.name,
	],
	work: [
